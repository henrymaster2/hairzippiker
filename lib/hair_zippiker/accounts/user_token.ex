defmodule HairZippiker.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias HairZippiker.Accounts.UserToken
  ...
  def verify_email_token_query(token, "login"), do: verify_magic_link_token_query(token)
